"""
train_v8.py —— 从 V7 继续训练到 V8（突破 100万片段）
...
def main():
    ...
    print("\n[1/4] 加载 V7 检查点...")
    if os.path.exists(os.path.join(V7_CKPT, "harmonia_lite.json.gz")):
        model = Harmonia13Virtual.load(V7_CKPT)
        print(f"  ✅ 已加载 V7")
    else:
